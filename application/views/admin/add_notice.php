    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
		  ...
		  <form action="<?php echo base_url('add_notice'); ?>" method="post" enctype="multipart/form-data">
          <!-- /.card-header -->
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="notice" class="form-control" id="exampleInputEmail1" placeholder="Enter Job Title">
                  </div>
